...
`define  REG_ID_DEFAULT				32'h0008DEAD
...
`define  REG_RATEBASE_BITS				31:0
`define  REG_RATEBASE_WIDTH				32
`define  REG_RATEBASE_DEFAULT				32'h0
`define  REG_RATEBASE_ADDR				32'h1C

`define  REG_RATEVALID_BITS				31:0
`define  REG_RATEVALID_WIDTH				32
`define  REG_RATEVALID_DEFAULT				32'h0
`define  REG_RATEVALID_ADDR				32'h20

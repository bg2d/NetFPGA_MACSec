...
# crypto_switch
# ###################
set my_repo $::env(NF_DESIGN_DIR)/hw/local_ip
...
file copy -force ${my_repo}/ ${repo_dir}/std/cores/
...
# crypto_switch
# #####################
create_ip -name MACsec -vendor NetFPGA -library NetFPGA -module_name MACsec
set_property generate_synth_checkpoint false [get_files MACsec.xci]
reset_target all [get_ips MACsec]
generate_target all [get_ips MACsec]
...
add_wave_divider MAC_SEC
add_wave {{/top_tb/top_sim/nf_datapath_0/crypto_1/inst}}
run 300us

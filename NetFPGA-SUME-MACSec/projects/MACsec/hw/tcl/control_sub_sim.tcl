...
# TODO
# #######################################
# crypto_switch address segment
# #######################################
assign_bd_address [get_bd_addr_segs {M04_AXI/Reg }]  
  set_property offset $M09_BASEADDR [get_bd_addr_segs {S00_AXI/SEG_M04_AXI_Reg}]
  set_property range $M09_SIZEADDR [get_bd_addr_segs {S00_AXI/SEG_M04_AXI_Reg}] 
